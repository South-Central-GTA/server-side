...
public class ItemKeyService : BaseService<ItemKeyModel>, ITransientScript
{
    private readonly IDbContextFactory<DatabaseContext> _dbContextFactory;

    public ItemKeyService(IDbContextFactory<DatabaseContext> dbContextFactory) : base(dbContextFactory)
    {
    ...
    public override async Task<List<ItemKeyModel>> GetAll()
    {
        ...
        return await dbContext.ItemKeys.Include(i => i.CatalogItemModel).Include(i => i.InventoryModel)
