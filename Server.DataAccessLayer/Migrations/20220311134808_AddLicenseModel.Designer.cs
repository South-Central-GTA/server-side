...
namespace Server.DataAccessLayer.Migrations
{
    ...
    [Migration("20220311134808_AddLicenseModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Database.Models.Character.LicenseModel", b =>
                {
                    b.Property<int>("CharacterModelId")
                        .HasColumnType("integer");

                    b.Property<int>("CharacterModelId1")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Server.Database.Models.Mdc.MdcNodeModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Server.Database.Models.Character.LicenseModel", b =>
                {
                    b.HasOne("Server.Database.Models.Character.CharacterModel", "CharacterModel")
                        .WithMany("Licenses")
                        .HasForeignKey("CharacterModelId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
