    ...
    : ModelBase
{
    ...
    [JsonPropertyName("headCollection")] 
    public string HeadCollection { get; set; } = "";

    [JsonPropertyName("headHash")] 
    public string HeadHash { get; set; } = "";

    [JsonPropertyName("torsoCollection")] 
    public string TorsoCollection { get; set; } = "";

    [JsonPropertyName("torsoHash")] 
    public string TorsoHash { get; set; } = "";

    [JsonPropertyName("leftArmCollection")]
    public string LeftArmCollection { get; set; } = "";

    [JsonPropertyName("leftArmHash")] 
    public string LeftArmHash { get; set; } = "";

    [JsonPropertyName("rightArmCollection")]
    public string RightArmCollection { get; set; } = "";

    [JsonPropertyName("rightArmHash")] 
    public string RightArmHash { get; set; } = "";

    [JsonPropertyName("leftLegCollection")]
    public string LeftLegCollection { get; set; } = "";

    [JsonPropertyName("leftLegHash")] 
    public string LeftLegHash { get; set; } = "";
