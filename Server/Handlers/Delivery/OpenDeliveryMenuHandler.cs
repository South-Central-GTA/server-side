...
public class OpenDeliveryMenuHandler : ISingletonScript
{
    ...
    public OpenDeliveryMenuHandler(IOptions<CompanyOptions> companyOptions, DeliveryService deliveryService,
        GroupService groupService, GroupModule groupModule)
    {
    ...
    private async void OnRequestMenu(ServerPlayer player)
    {
        ...
        if (group != null)
        {
            ...
            canUseThisApp =
                await _groupModule.HasPermission(player.CharacterModel.Id, group.Id, GroupPermission.ORDER_PRODUCTS);
        ...
        player.EmitGui("delivery:setup", canUseThisApp, canSeeOpenDeliveries, hasOpenDelivery, products,
