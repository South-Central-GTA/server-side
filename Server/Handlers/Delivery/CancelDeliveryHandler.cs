...
public class CancelDeliveryHandler : ISingletonScript
{
    ...
    public CancelDeliveryHandler(DeliveryService deliveryService, GroupService groupService, GroupModule groupModule,
