...
internal class RoleplayCommands : ISingletonScript
{
    ...
    [Command("do", "Definiere etwas in unserer Spielwelt.", Permission.NONE, new[] { "Definition" },
        CommandArgs.GREEDY)]
    ...
    [Command("emote", "Definiere eine sichtbare Aktion deines Charakters.", Permission.NONE, new[] { "Tätigkeit" },
        CommandArgs.GREEDY, new[] { "me" })]
    ...
    [Command("lowemote", "Definiere eine sichtbare Aktion deines Charakters.", Permission.NONE, new[] { "Tätigkeit" },
        CommandArgs.GREEDY, new[] { "lme" })]
    ...
    [Command("my", "Emote etwas was mit deinem Charakter passiert oder mit seinem Eigentum.", Permission.NONE,
        new[] { "Definition" }, CommandArgs.GREEDY)]
    ...
    [Command("ooc", "Schreibe etwas außerhalb des Rollenspiels zu anderen Spielern.", Permission.NONE,
        new[] { "Nachricht" }, CommandArgs.GREEDY, new[] { "b" })]
    ...
    [Command("scream", "Schreie/rufe eine Nachricht als dein Charakter.", Permission.NONE, new[] { "Nachricht" },
        CommandArgs.GREEDY, new[] { "s" })]
    ...
    [Command("whisper", "Flüstere eine Nachricht als dein Charakter.", Permission.NONE, new[] { "Nachricht" },
        CommandArgs.GREEDY, new[] { "w", "lr", "low", "fl" })]
    ...
    [Command("megaphone", "Spreche als dein Charakter durch ein Megafon.", Permission.NONE, new[] { "Nachricht" },
        CommandArgs.GREEDY, new[] { "m" })]
    public async void OnMegafon(ServerPlayer player, string message)
    {
        ...
        var item = player.CharacterModel.InventoryModel.Items.FirstOrDefault(i =>
            i.CatalogItemModelId == ItemCatalogIds.MEGAPHONE);
        if (item == null)
        {
