...
public class GasStationScheduledJob
    : ScheduledJob
{
    ...
    {
        _worldMarketModule.FuelPrice = new Dictionary<FuelType, int> { { FuelType.DIESEL, _random.Next(5, 10) }, { FuelType.PETROL, _random.Next(5, 10) }, { FuelType.KEROSENE, _random.Next(5, 10) }, { FuelType.ELECTRICITY, _random.Next(5, 10) } };
